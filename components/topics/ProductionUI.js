...
export default function ProductionUI({ data }) {
  ...
  return (
    <div id="prod-theme" style={{ display: 'flex', flexDirection: 'column', background: '#ffffff', minHeight: '100vh', width: '100%', color: '#334155', fontFamily: '"Inter", system-ui, sans-serif' }}>
      ...
      <div style={{ background: '#f8fafc', borderBottom: '1px solid #e2e8f0', padding: '5rem 1rem' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <h1 style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', fontWeight: 800, color: '#0f172a', margin: '0 0 1.5rem', letterSpacing: '-0.02em', lineHeight: 1.1 }}>
            {data.titleHTML}
          </h1>
        ...
        <div className="pipeline-container">
          ...
          <div className="pipeline-node">
            ...
            <div className="node-content">
              ...
              <h3 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#0f172a', margin: '0 0 1.5rem' }}>Latest Architectural Updates</h3>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem' }}>
                {data.news.slice(0, 4).map((item, idx) => (
                  <div key={idx} style={{ borderLeft: `3px solid ${brandColorPrimary}`, paddingLeft: '1rem' }}>
                    <h4 style={{ fontSize: '1rem', fontWeight: 600, margin: '0 0 0.5rem', lineHeight: 1.3 }}>
            ...
            <div className="node-content">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                {data.podcasts.map((item, idx) => (
                  <div key={idx} style={{ display: 'flex', gap: '1rem', alignItems: 'center', background: '#ffffff', padding: '1rem', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
